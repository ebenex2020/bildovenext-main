  ...
  return (
    <section className="min-h-full">
      <div className="container mx-auto px-4 py-10">
        ...
        <div className="mb-5">
          Our team of financial professionals brings a diverse range of
          expertise and backgrounds. With their combined knowledge and
          dedication, they are here to guide you towards financial success and
          provide the support you need at every step.
        </div>
        ...
        {selectedMember && (
          ...
          >
            <div className="bg-white p-8 rounded-lg">
              ...
              />
              <p className="mb-2">{selectedMember.position}</p>
              <p>{selectedMember.bio}</p>
              <Button className="mt-4 outline-dotted" onClick={closeModal}>
                Close
              </Button>
            </div>
          </motion.div>
